...
@section('title', 'Egresos de Caja desde ' . $fechaInicio . ' hasta ' . $fechaFin)
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <h1 class="text-center">Egresos de Caja desde {{ $fechaInicio }} hasta {{ $fechaFin }}</h1>
            </div>
        </div>
        ...
        @else
            <p class="text-center mt-4">No hay egresos registrados para el período seleccionado.</p>
        @endif
