                    ...
                    <div class="card-body">
                        <form action="{{ route('vehiculo.store') }}" method="POST" novalidate>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="placa_vehiculo"
                                ...
                                <div class="col-md-6">
                                    <div class="info-box bg-info">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span
                                                class="info-box-number">{{ \Carbon\Carbon::now()->format('H:i:s') }}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="info-box bg-success">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span
                                                class="info-box-number">{{ \Carbon\Carbon::now()->format('Y-m-d') }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
