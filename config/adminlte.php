...
return [
    ...
    */
    ...
    'google_fonts' => [
        'allowed' => true, // Activa las fuentes de Google
        'fonts' => [
            'Roboto' => [
                'Roboto',
                '400',
                'italic', // Agregamos "italic" para la variante Italic
            ],
        ],
    ],
    ...
    */
    ...
    'classes_content' => '',
    'classes_sidebar' => 'bg-dark elevation-4',
    'classes_sidebar_nav' => 'text-orange',
    'classes_topnav' => 'navbar-dark bg-orange navbar-light',
